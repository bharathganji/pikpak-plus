...
class PikPakApi:
    ...
    def _make_request(
        ...
        with httpx.Client(**self.httpx_client_args) as client:
    ...
    def _request_delete(
        ...
        return self._make_request("delete", url, params=params, data=data)
    ...
    def captcha_init(self, action: str, meta: dict = None) -> Dict[str, Any]:
    ...
    def create_folder(
        ...
        result = self._request_post(url, data)
        return result
    ...
    def offline_download(
        ...
        result = self._request_post(download_url, download_data)
        return result
    ...
    def offline_list(
        ...
        result = self._request_get(list_url, list_data)
        return result
    ...
    def offline_file_info(self, file_id: str) -> Dict[str, Any]:
        ...
        result = self._request_get(url, {"thumbnail_size": "SIZE_LARGE"})
        return result
    ...
    def offline_task_retry(self, task_id: str) -> Dict[str, Any]:
        ...
        try:
            result = self._request_post(list_url, list_data)
            return result
    ...
    def delete_tasks(
        ...
        try:
            self._request_delete(delete_url, params=params)
        except Exception as e:
    ...
    def file_move_or_copy_by_path(
        ...
        if to_path_ids:
            ...
            to_parent_id = None
        if move:
            result = self.file_batch_move(ids=from_ids, to_parent_id=to_parent_id)
        else:
            result = self.file_batch_copy(ids=from_ids, to_parent_id=to_parent_id)
        return result
    ...
    def file_rename(self, id: str, new_file_name: str) -> Dict[str, Any]:
        """
        id: str - 文件id
    ...
    def get_transfer_quota(self) -> Dict[str, Any]:
        """
        Get transfer quota
        """
